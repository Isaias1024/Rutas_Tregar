...
| Grupo | Ruta | Que es |
|---|---|---|
| `(auth)` | `/login` | Entrada con Google **o** con correo y contraseña. Ninguna de las dos crea cuentas: exige una fila previa en `usuario` |
...
| | `/catalogos/supervisores` | Solo admin: alta de supervisores (entran por Google o por credencial+contraseña, mostrada una sola vez) |
...
| | `/cuenta` | Correo, credencial y rol de solo lectura, mas cambio de contraseña. Fuerza el paso aqui cuando `debe_cambiar_password` sigue en `true` |
